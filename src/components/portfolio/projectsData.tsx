...
export const PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    caseStudy: {
      ...
      story:
        'The weekend hackathon build is now a <strong>side business with paying customers</strong> at <a href="https://www.inzerpro.cz" target="_blank" rel="noopener noreferrer">inzerpro.cz</a>. I pitched it again at the <a href="/blog/zero-to-done">Zero to Done hackathon</a> in Brno: real customers, not a demo. Read the full <a href="/projects/inzerpro">case study</a> for what it does for sellers and how it runs unattended.',
    },
