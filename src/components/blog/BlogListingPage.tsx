    ...
    <div className="blog-listing" data-theme={theme}>
      ...
      <div className="blog-listing__inner">
        <div className="blog-listing__topbar">
          <LocaleLink to="/" className="blog-back">
            <FaArrowLeft />
            {t.backHome}
          </LocaleLink>
        </div>
        ...
        {featured && (
          <LocaleLink to={`/blog/${featured.slug}`} className="blog-feature">
            {featuredThumb && (
        ...
        <div className="blog-rows">
          {rest.map((post) => {
            ...
            return (
              <LocaleLink to={`/blog/${post.slug}`} key={post.slug} className="blog-row">
          ...
          <LocaleLink to="/things" className="blog-row">
            <div className="blog-row__body">
              <div className="blog-row__meta">
