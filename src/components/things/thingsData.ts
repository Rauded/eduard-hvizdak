...
export const THINGS: Thing[] = [
  ...
  },
  {
    ...
    why: 'My focus bubble. Noise cancelling on, a long playlist or silence, and the room goes quiet — a big chunk of my deep-work hours run through these. Transparency mode is good enough that I barely bother taking them out.',
