...
const czsChatbot = {
  ...
  hero: {
    ...
    figureCaption: 'Live on Masaryk University\'s official CZS site. This is the production widget on the real page, not a prototype.',
  ...
  product: {
    ...
    captionWidgetLive: 'The live widget on the official CZS page. It opens with a plain AI disclaimer and suggested questions, in the student\'s language.',
    captionAnswerLive: 'A real answer on the production site. It cites 11 named source documents (expanded here) and takes thumbs up or down feedback that routes to a human review queue.',
    ...
    answerCaption: 'The bot answers in Czech or English. Every claim is backed by a cited CZS source, shown on each answer.',
  },
  architecture: {
    ...
    body: [
      ...
      'Generation runs on CERIT, the Czech national academic AI infrastructure, with classification offloaded to OpenAI to keep CERIT\'s limited slots for answer generation. The whole stack, retrieval, dashboards, and evaluation included, runs on a single 8 GB server behind nginx. Retrieval, generation, freshness, evaluation, and the staff tooling are one coherent system, designed, built, and shipped to production by one person.',
    ],
