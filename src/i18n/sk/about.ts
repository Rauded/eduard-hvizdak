...
const about = {
  ...
  highlightTitleSuffix: 'na diskusiu o zákone Digital Fairness Act',
  highlightDescPrefix: 'S eurokomisárom',
  highlightDescSpan: 'Michaelom McGrathom',
  highlightDescSuffix: 'ako súčasť iniciatívy Youth Policy Dialogue.',
  highlightCta: 'Prečítať príbeh',
};
