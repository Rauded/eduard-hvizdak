...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: `
      ...
      <figure class="blog-figure">
        <img src="/blog/erasmus/photo1.jpg" alt="Slovak team at the cultural night dinner table" class="blog-img" />
      </figure>
      ...
      <figure class="blog-figure">
        <img src="/blog/erasmus/photo3.jpg" alt="Group photo at sunset during the Erasmus+ exchange" class="blog-img" />
      </figure>
      ...
      <figure class="blog-figure">
        <img src="/blog/erasmus/photo2.jpg" alt="Full group photo of all Erasmus+ participants" class="blog-img" />
      </figure>
